...
/// okay move na ulit sa next testing
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    // login error
	header("Location: id_number_retry_2.php");
    exit();
  }
...
<div class="box1 flex-box justify-content-center"> <!-- box thingy -->
		<div class=" d-flex-col justify-content-center text-center text-danger" style="font-size:2.5vh; margin-top: 2vh;"> Incorrect login credentials <!-- box3 for little top spacing -->
